...
.method private onHandshake(Lio/socket/engineio/client/HandshakeData;)V
    ...
    iput-object v4, v3, Lio/socket/engineio/client/Socket;->id:Ljava/lang/String;
    ...
    iget-object v3, v3, Lio/socket/engineio/client/Transport;->query:Ljava/util/Map;

    const-string v4, "sid"

    move-object v5, v2

    iget-object v5, v5, Lio/socket/engineio/client/HandshakeData;->sid:Ljava/lang/String;
    ...
    iget-object v5, v5, Lio/socket/engineio/client/HandshakeData;->upgrades:[Ljava/lang/String;

    invoke-static {v5}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v5

    invoke-virtual {v4, v5}, Lio/socket/engineio/client/Socket;->filterUpgrades(Ljava/util/List;)Ljava/util/List;

    move-result-object v4

    iput-object v4, v3, Lio/socket/engineio/client/Socket;->upgrades:Ljava/util/List;
    ...
    iget-wide v4, v4, Lio/socket/engineio/client/HandshakeData;->pingInterval:J

    iput-wide v4, v3, Lio/socket/engineio/client/Socket;->pingInterval:J
    ...
    iget-wide v4, v4, Lio/socket/engineio/client/HandshakeData;->pingTimeout:J

    iput-wide v4, v3, Lio/socket/engineio/client/Socket;->pingTimeout:J

    .line 526
    move-object v3, v1

    invoke-direct {v3}, Lio/socket/engineio/client/Socket;->onOpen()V
    ...
    iget-object v5, v5, Lio/socket/engineio/client/Socket;->onHeartbeatAsListener:Lio/socket/emitter/Emitter$Listener;

    invoke-virtual {v3, v4, v5}, Lio/socket/engineio/client/Socket;->off(Ljava/lang/String;Lio/socket/emitter/Emitter$Listener;)Lio/socket/emitter/Emitter;
    ...
    invoke-virtual {v3, v4, v5}, Lio/socket/engineio/client/Socket;->on(Ljava/lang/String;Lio/socket/emitter/Emitter$Listener;)Lio/socket/emitter/Emitter;
...
.method private setPing()V
    ...
    iget-object v3, v3, Lio/socket/engineio/client/Socket;->pingIntervalTimer:Ljava/util/concurrent/Future;
    ...
    invoke-direct {v4}, Lio/socket/engineio/client/Socket;->getHeartbeatScheduler()Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v4

    new-instance v5, Lio/socket/engineio/client/Socket$15;
    ...
    invoke-direct {v6, v7, v8}, Lio/socket/engineio/client/Socket$15;-><init>(Lio/socket/engineio/client/Socket;Lio/socket/engineio/client/Socket;)V

    move-object v6, v1

    iget-wide v6, v6, Lio/socket/engineio/client/Socket;->pingInterval:J
    ...
    iput-object v4, v3, Lio/socket/engineio/client/Socket;->pingIntervalTimer:Ljava/util/concurrent/Future;
