...
.method private readControlFrame()V
    ...
    iget-wide v10, v10, Lokhttp3/internal/ws/WebSocketReader;->frameLength:J
    ...
    iget-boolean v8, v8, Lokhttp3/internal/ws/WebSocketReader;->isClient:Z
    ...
    invoke-interface {v8, v9, v10, v11}, Lokio/BufferedSource;->readFully(Lokio/Buffer;J)V

    .line 185
    :cond_0
    move-object v8, v1

    iget v8, v8, Lokhttp3/internal/ws/WebSocketReader;->opcode:I
    ...
    iget v11, v11, Lokhttp3/internal/ws/WebSocketReader;->opcode:I
    ...
    iget-object v11, v11, Lokhttp3/internal/ws/WebSocketReader;->maskKey:[B

    move-object v12, v1

    iget-wide v12, v12, Lokhttp3/internal/ws/WebSocketReader;->frameBytesRead:J
    ...
    iget-object v10, v10, Lokhttp3/internal/ws/WebSocketReader;->maskBuffer:[B
    ...
    invoke-interface {v8, v9, v10, v11}, Lokio/BufferedSource;->read([BII)I
    ...
    iget-object v8, v8, Lokhttp3/internal/ws/WebSocketReader;->frameCallback:Lokhttp3/internal/ws/WebSocketReader$FrameCallback;
    ...
    invoke-interface {v8, v9}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPing(Lokio/ByteString;)V
    ...
    invoke-interface {v8, v9}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadPong(Lokio/ByteString;)V
    ...
    invoke-virtual {v8}, Lokio/Buffer;->readShort()S
    ...
    invoke-static {v8}, Lokhttp3/internal/ws/WebSocketProtocol;->closeCodeExceptionMessage(I)Ljava/lang/String;
    ...
    invoke-interface {v8, v9, v10}, Lokhttp3/internal/ws/WebSocketReader$FrameCallback;->onReadClose(ILjava/lang/String;)V
    ...
    iput-boolean v9, v8, Lokhttp3/internal/ws/WebSocketReader;->closed:Z
