...
.method private declared-synchronized send(Lokio/ByteString;I)Z
    ...
    iget-boolean v4, v4, Lokhttp3/internal/ws/RealWebSocket;->enqueuedClose:Z
    :try_end_0
    ...
    invoke-virtual {v4, v5, v6}, Lokhttp3/internal/ws/RealWebSocket;->close(ILjava/lang/String;)Z
    ...
    iget-wide v5, v5, Lokhttp3/internal/ws/RealWebSocket;->queueSize:J
    ...
    iput-wide v5, v4, Lokhttp3/internal/ws/RealWebSocket;->queueSize:J

    .line 360
    move-object v4, v1

    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket;->messageAndCloseQueue:Ljava/util/ArrayDeque;

    new-instance v5, Lokhttp3/internal/ws/RealWebSocket$Message;
    ...
    invoke-direct {v6, v7, v8}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILokio/ByteString;)V
    ...
    invoke-direct {v4}, Lokhttp3/internal/ws/RealWebSocket;->runWriter()V
    :try_end_1
...
.method public initReaderAndWriter(Ljava/lang/String;JLokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    :try_start_0
    iput-object v9, v8, Lokhttp3/internal/ws/RealWebSocket;->streams:Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iget-boolean v11, v11, Lokhttp3/internal/ws/RealWebSocket$Streams;->client:Z

    move-object v12, v5

    iget-object v12, v12, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lokio/BufferedSink;

    move-object v13, v1

    iget-object v13, v13, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v10, v11, v12, v13}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLokio/BufferedSink;Ljava/util/Random;)V

    iput-object v9, v8, Lokhttp3/internal/ws/RealWebSocket;->writer:Lokhttp3/internal/ws/WebSocketWriter;
    ...
    invoke-static {v12, v13}, Lokhttp3/internal/Util;->threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;

    move-result-object v12

    invoke-direct {v10, v11, v12}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    iput-object v9, v8, Lokhttp3/internal/ws/RealWebSocket;->executor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    iget-object v8, v8, Lokhttp3/internal/ws/RealWebSocket;->executor:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v9, Lokhttp3/internal/ws/RealWebSocket$PingRunnable;
    ...
    invoke-direct {v10, v11, v12}, Lokhttp3/internal/ws/RealWebSocket$PingRunnable;-><init>(Lokhttp3/internal/ws/RealWebSocket;Lokhttp3/internal/ws/RealWebSocket$1;)V
    ...
    iget-object v8, v8, Lokhttp3/internal/ws/RealWebSocket;->messageAndCloseQueue:Ljava/util/ArrayDeque;
    ...
    invoke-direct {v8}, Lokhttp3/internal/ws/RealWebSocket;->runWriter()V
    ...
    new-instance v9, Lokhttp3/internal/ws/WebSocketReader;
    ...
    iget-object v12, v12, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lokio/BufferedSource;

    move-object v13, v1

    invoke-direct {v10, v11, v12, v13}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLokio/BufferedSource;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V

    iput-object v9, v8, Lokhttp3/internal/ws/RealWebSocket;->reader:Lokhttp3/internal/ws/WebSocketReader;
...
.method writeOneFrame()Z
    ...
    :try_start_0
    iget-boolean v15, v15, Lokhttp3/internal/ws/RealWebSocket;->failed:Z
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->writer:Lokhttp3/internal/ws/WebSocketWriter;
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->pongQueue:Ljava/util/ArrayDeque;
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->messageAndCloseQueue:Ljava/util/ArrayDeque;
    ...
    instance-of v15, v15, Lokhttp3/internal/ws/RealWebSocket$Close;
    ...
    iget v15, v15, Lokhttp3/internal/ws/RealWebSocket;->receivedCloseCode:I
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->receivedCloseReason:Ljava/lang/String;
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->streams:Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    iput-object v0, v15, Lokhttp3/internal/ws/RealWebSocket;->streams:Lokhttp3/internal/ws/RealWebSocket$Streams;

    .line 444
    move-object v15, v3

    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->executor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    :try_start_1
    invoke-virtual/range {v15 .. v16}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lokio/ByteString;)V
    :try_end_1
    ...
    iget-object v0, v0, Lokhttp3/internal/ws/RealWebSocket;->executor:Ljava/util/concurrent/ScheduledExecutorService;

    move-object/from16 v16, v0

    new-instance v17, Lokhttp3/internal/ws/RealWebSocket$CancelRunnable;
    ...
    invoke-direct/range {v18 .. v19}, Lokhttp3/internal/ws/RealWebSocket$CancelRunnable;-><init>(Lokhttp3/internal/ws/RealWebSocket;)V

    move-object/from16 v18, v6

    check-cast v18, Lokhttp3/internal/ws/RealWebSocket$Close;

    move-object/from16 v0, v18

    iget-wide v0, v0, Lokhttp3/internal/ws/RealWebSocket$Close;->cancelAfterCloseMillis:J
    ...
    iput-object v0, v15, Lokhttp3/internal/ws/RealWebSocket;->cancelFuture:Ljava/util/concurrent/ScheduledFuture;
    ...
    :try_start_3
    instance-of v15, v15, Lokhttp3/internal/ws/RealWebSocket$Message;
    ...
    check-cast v15, Lokhttp3/internal/ws/RealWebSocket$Message;

    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lokio/ByteString;
    ...
    check-cast v16, Lokhttp3/internal/ws/RealWebSocket$Message;

    move-object/from16 v0, v16

    iget v0, v0, Lokhttp3/internal/ws/RealWebSocket$Message;->formatOpcode:I
    ...
    .line 462
    invoke-virtual/range {v15 .. v18}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lokio/Sink;

    move-result-object v15

    invoke-static {v15}, Lokio/Okio;->buffer(Lokio/Sink;)Lokio/BufferedSink;
    ...
    invoke-interface/range {v15 .. v16}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-interface {v15}, Lokio/BufferedSink;->close()V
    ...
    iget-wide v0, v0, Lokhttp3/internal/ws/RealWebSocket;->queueSize:J
    ...
    iput-wide v0, v15, Lokhttp3/internal/ws/RealWebSocket;->queueSize:J
    ...
    iget v0, v0, Lokhttp3/internal/ws/RealWebSocket$Close;->code:I
    ...
    iget-object v0, v0, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lokio/ByteString;

    move-object/from16 v17, v0

    invoke-virtual/range {v15 .. v17}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILokio/ByteString;)V
    ...
    iget-object v15, v15, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;
    ...
    invoke-virtual/range {v15 .. v18}, Lokhttp3/WebSocketListener;->onClosed(Lokhttp3/WebSocket;ILjava/lang/String;)V
