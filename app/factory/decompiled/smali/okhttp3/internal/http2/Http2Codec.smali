...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    iget-object v5, v5, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-static {v5}, Lokhttp3/internal/http2/Http2Codec;->http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Http2Codec;->connection:Lokhttp3/internal/http2/Http2Connection;

    move-object v7, v4

    move v8, v3

    invoke-virtual {v6, v7, v8}, Lokhttp3/internal/http2/Http2Connection;->newStream(Ljava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;

    move-result-object v6

    iput-object v6, v5, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;
    ...
    invoke-virtual {v5}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lokio/Timeout;

    move-result-object v5

    move-object v6, v1

    iget-object v6, v6, Lokhttp3/internal/http2/Http2Codec;->client:Lokhttp3/OkHttpClient;
    ...
    invoke-virtual {v5}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lokio/Timeout;
