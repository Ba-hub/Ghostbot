...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->okHttpSettings:Lokhttp3/internal/http2/Settings;
    ...
    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->peerSettings:Lokhttp3/internal/http2/Settings;
    ...
    iput-boolean v4, v3, Lokhttp3/internal/http2/Http2Connection;->receivedInitialPeerSettings:Z
    ...
    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->currentPushRequests:Ljava/util/Set;
    ...
    iget-object v4, v4, Lokhttp3/internal/http2/Http2Connection$Builder;->pushObserver:Lokhttp3/internal/http2/PushObserver;

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->pushObserver:Lokhttp3/internal/http2/PushObserver;
    ...
    iget-boolean v4, v4, Lokhttp3/internal/http2/Http2Connection$Builder;->client:Z

    iput-boolean v4, v3, Lokhttp3/internal/http2/Http2Connection;->client:Z
    ...
    iget-object v4, v4, Lokhttp3/internal/http2/Http2Connection$Builder;->listener:Lokhttp3/internal/http2/Http2Connection$Listener;

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->listener:Lokhttp3/internal/http2/Http2Connection$Listener;
    ...
    :goto_0
    iput v4, v3, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    :goto_1
    iput v4, v3, Lokhttp3/internal/http2/Http2Connection;->nextPingId:I
    ...
    iget-object v4, v4, Lokhttp3/internal/http2/Http2Connection$Builder;->hostname:Ljava/lang/String;

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->hostname:Ljava/lang/String;
    ...
    const-string v12, "OkHttp %s Push Observer"
    ...
    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->pushExecutor:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v4, v4, Lokhttp3/internal/http2/Http2Connection$Builder;->socket:Ljava/net/Socket;

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->socket:Ljava/net/Socket;
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lokio/BufferedSink;

    move-object v7, v1

    iget-boolean v7, v7, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v5, v6, v7}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lokio/BufferedSink;Z)V

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lokio/BufferedSource;

    move-object v10, v1

    iget-boolean v10, v10, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v8, v9, v10}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lokio/BufferedSource;Z)V

    invoke-direct {v5, v6, v7}, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;-><init>(Lokhttp3/internal/http2/Http2Connection;Lokhttp3/internal/http2/Http2Reader;)V

    iput-object v4, v3, Lokhttp3/internal/http2/Http2Connection;->readerRunnable:Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;
...
.method private newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v14, v14, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    :try_start_1
    iget-boolean v14, v14, Lokhttp3/internal/http2/Http2Connection;->shutdown:Z

    if-eqz v14, :cond_1

    .line 219
    new-instance v14, Lokhttp3/internal/http2/ConnectionShutdownException;
    ...
    invoke-direct {v15}, Lokhttp3/internal/http2/ConnectionShutdownException;-><init>()V
    ...
    iget v15, v15, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I

    const/16 v16, 0x2

    add-int/lit8 v15, v15, 0x2

    iput v15, v14, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    invoke-direct/range {v15 .. v20}, Lokhttp3/internal/http2/Http2Stream;-><init>(ILokhttp3/internal/http2/Http2Connection;ZZLjava/util/List;)V
    ...
    iget-wide v14, v14, Lokhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J
    ...
    iget-wide v14, v14, Lokhttp3/internal/http2/Http2Stream;->bytesLeftInWriteWindow:J
    ...
    invoke-virtual {v14}, Lokhttp3/internal/http2/Http2Stream;->isOpen()Z
    ...
    invoke-virtual/range {v14 .. v18}, Lokhttp3/internal/http2/Http2Writer;->synStream(ZIILjava/util/List;)V
    ...
    invoke-virtual {v14}, Lokhttp3/internal/http2/Http2Writer;->flush()V
    ...
    :try_start_5
    iget-boolean v14, v14, Lokhttp3/internal/http2/Http2Connection;->client:Z
    ...
    const-string v16, "client streams shouldn\'t have associated stream IDs"
    ...
    invoke-virtual/range {v14 .. v17}, Lokhttp3/internal/http2/Http2Writer;->pushPromise(IILjava/util/List;)V
    :try_end_5
...
.method addBytesToWriteWindow(J)V
    ...
    iget-wide v5, v5, Lokhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J

    move-wide v7, v2

    add-long/2addr v5, v7

    iput-wide v5, v4, Lokhttp3/internal/http2/Http2Connection;->bytesLeftInWriteWindow:J
...
.method start(Z)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/http2/Http2Writer;->connectionPreface()V
    ...
    invoke-virtual {v4, v5}, Lokhttp3/internal/http2/Http2Writer;->settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-virtual {v4, v5, v6, v7}, Lokhttp3/internal/http2/Http2Writer;->windowUpdate(IJ)V
    ...
    iget-object v6, v6, Lokhttp3/internal/http2/Http2Connection;->readerRunnable:Lokhttp3/internal/http2/Http2Connection$ReaderRunnable;
