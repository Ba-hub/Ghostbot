...
.method setLengths([Ljava/lang/String;)V
    ...
    invoke-direct {v4, v5}, Lokhttp3/internal/cache/DiskLruCache$Entry;->invalidLengths([Ljava/lang/String;)Ljava/io/IOException;
    ...
    iget-object v4, v4, Lokhttp3/internal/cache/DiskLruCache$Entry;->lengths:[J
...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    iget-object v8, v8, Lokhttp3/internal/cache/DiskLruCache$Entry;->this$0:Lokhttp3/internal/cache/DiskLruCache;

    iget-object v8, v8, Lokhttp3/internal/cache/DiskLruCache;->fileSystem:Lokhttp3/internal/io/FileSystem;

    move-object v9, v1

    iget-object v9, v9, Lokhttp3/internal/cache/DiskLruCache$Entry;->cleanFiles:[Ljava/io/File;
    ...
    .line 1026
    :cond_1
    new-instance v6, Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    iget-object v9, v9, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    move-object v10, v1

    iget-wide v10, v10, Lokhttp3/internal/cache/DiskLruCache$Entry;->sequenceNumber:J

    move-object v12, v2

    move-object v13, v3

    invoke-direct/range {v7 .. v13}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lokio/Source;[J)V
    :try_end_0
    ...
    invoke-virtual {v6, v7}, Lokhttp3/internal/cache/DiskLruCache;->removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    :try_end_1
...
.method writeLengths(Lokio/BufferedSink;)V
    ...
    invoke-interface {v8, v9, v10}, Lokio/BufferedSink;->writeDecimalLong(J)Lokio/BufferedSink;
