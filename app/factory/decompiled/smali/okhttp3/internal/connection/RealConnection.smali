...
.method public constructor <init>(Lokhttp3/Route;)V
    ...
    invoke-direct {v3}, Lokhttp3/internal/http2/Http2Connection$Listener;-><init>()V
    ...
    iput-object v4, v3, Lokhttp3/internal/connection/RealConnection;->allocations:Ljava/util/List;
    ...
    iput-object v4, v3, Lokhttp3/internal/connection/RealConnection;->route:Lokhttp3/Route;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 292
    :goto_0
    new-instance v13, Lokhttp3/internal/http1/Http1Codec;
    ...
    invoke-direct/range {v14 .. v18}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lokio/BufferedSource;Lokio/BufferedSink;)V
    ...
    iget-object v13, v13, Lokhttp3/internal/connection/RealConnection;->source:Lokio/BufferedSource;
    ...
    invoke-virtual/range {v13 .. v16}, Lokio/Timeout;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/Timeout;
    ...
    iget-object v13, v13, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/BufferedSink;

    invoke-interface {v13}, Lokio/BufferedSink;->timeout()Lokio/Timeout;
    ...
    invoke-virtual {v14}, Lokhttp3/Request;->headers()Lokhttp3/Headers;

    move-result-object v14

    move-object v15, v7

    invoke-virtual {v13, v14, v15}, Lokhttp3/internal/http1/Http1Codec;->writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V

    .line 296
    move-object v13, v8

    invoke-virtual {v13}, Lokhttp3/internal/http1/Http1Codec;->finishRequest()V

    .line 297
    move-object v13, v8

    invoke-virtual {v13}, Lokhttp3/internal/http1/Http1Codec;->readResponse()Lokhttp3/Response$Builder;

    move-result-object v13

    move-object v14, v5

    invoke-virtual {v13, v14}, Lokhttp3/Response$Builder;->request(Lokhttp3/Request;)Lokhttp3/Response$Builder;
    ...
    invoke-static {v13}, Lokhttp3/internal/http/HttpHeaders;->contentLength(Lokhttp3/Response;)J
    ...
    invoke-virtual {v13, v14, v15}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lokio/Source;
    ...
    invoke-static {v13, v14, v15}, Lokhttp3/internal/Util;->skipAll(Lokio/Source;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {v13}, Lokio/Source;->close()V
    ...
    const-string v16, "Unexpected response code for CONNECT: "
    ...
    invoke-interface {v13}, Lokio/BufferedSource;->buffer()Lokio/Buffer;
    ...
    invoke-interface {v13}, Lokio/BufferedSink;->buffer()Lokio/Buffer;
    ...
    const-string v15, "TLS tunnel buffered too many bytes!"
    ...
    invoke-virtual {v13}, Lokhttp3/Address;->proxyAuthenticator()Lokhttp3/Authenticator;

    move-result-object v13

    move-object v14, v2

    iget-object v14, v14, Lokhttp3/internal/connection/RealConnection;->route:Lokhttp3/Route;
    ...
    const-string v15, "Failed to authenticate with proxy"
    ...
    invoke-virtual {v14, v15}, Lokhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
