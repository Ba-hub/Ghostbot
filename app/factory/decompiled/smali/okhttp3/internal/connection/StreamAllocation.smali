...
.method public newStream(Lokhttp3/OkHttpClient;Z)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v13}, Lokhttp3/OkHttpClient;->connectTimeoutMillis()I
    ...
    invoke-virtual {v13}, Lokhttp3/OkHttpClient;->readTimeoutMillis()I
    ...
    invoke-virtual {v13}, Lokhttp3/OkHttpClient;->writeTimeoutMillis()I
    ...
    invoke-virtual {v13}, Lokhttp3/OkHttpClient;->retryOnConnectionFailure()Z
    ...
    :try_start_0
    invoke-direct/range {v13 .. v18}, Lokhttp3/internal/connection/StreamAllocation;->findHealthyConnection(IIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    iget-object v13, v13, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lokhttp3/internal/http2/Http2Connection;

    if-eqz v13, :cond_0

    .line 106
    new-instance v13, Lokhttp3/internal/http2/Http2Codec;
    ...
    invoke-direct/range {v14 .. v17}, Lokhttp3/internal/http2/Http2Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lokhttp3/internal/http2/Http2Connection;)V
    ...
    :try_start_1
    iput-object v14, v13, Lokhttp3/internal/connection/StreamAllocation;->codec:Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-direct {v14, v15}, Lokhttp3/internal/connection/RouteException;-><init>(Ljava/io/IOException;)V
