...
.method public constructor <init>(Lokhttp3/Response;)V
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->url:Ljava/lang/String;
    ...
    invoke-static {v4}, Lokhttp3/internal/http/HttpHeaders;->varyHeaders(Lokhttp3/Response;)Lokhttp3/Headers;

    move-result-object v4

    iput-object v4, v3, Lokhttp3/Cache$Entry;->varyHeaders:Lokhttp3/Headers;
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->requestMethod:Ljava/lang/String;
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->protocol:Lokhttp3/Protocol;
    ...
    iput v4, v3, Lokhttp3/Cache$Entry;->code:I
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->message:Ljava/lang/String;
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->responseHeaders:Lokhttp3/Headers;
    ...
    iput-object v4, v3, Lokhttp3/Cache$Entry;->handshake:Lokhttp3/Handshake;
    ...
    iput-wide v4, v3, Lokhttp3/Cache$Entry;->sentRequestMillis:J
    ...
    iput-wide v4, v3, Lokhttp3/Cache$Entry;->receivedResponseMillis:J
...
.method public constructor <init>(Lokio/Source;)V
    ...
    :try_start_0
    invoke-static/range {v21 .. v21}, Lokio/Okio;->buffer(Lokio/Source;)Lokio/BufferedSource;
    ...
    invoke-interface/range {v22 .. v22}, Lokio/BufferedSource;->readUtf8LineStrict()Ljava/lang/String;
    ...
    .line 544
    new-instance v21, Lokhttp3/Headers$Builder;
    ...
    invoke-static/range {v21 .. v21}, Lokhttp3/Cache;->readInt(Lokio/BufferedSource;)I
    ...
    invoke-virtual/range {v21 .. v22}, Lokhttp3/Headers$Builder;->addLenient(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    invoke-static/range {v21 .. v21}, Lokhttp3/internal/http/StatusLine;->parse(Ljava/lang/String;)Lokhttp3/internal/http/StatusLine;
    ...
    sget-object v22, Lokhttp3/Cache$Entry;->SENT_MILLIS:Ljava/lang/String;

    invoke-virtual/range {v21 .. v22}, Lokhttp3/Headers$Builder;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v22, Lokhttp3/Cache$Entry;->RECEIVED_MILLIS:Ljava/lang/String;
    ...
    invoke-virtual/range {v21 .. v22}, Lokhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    invoke-direct/range {v21 .. v21}, Lokhttp3/Cache$Entry;->isHttps()Z
    ...
    const-string v24, "expected \"\" but was \""
    ...
    invoke-interface/range {v21 .. v21}, Lokio/Source;->close()V
    ...
    invoke-static/range {v21 .. v21}, Lokhttp3/CipherSuite;->forJavaName(Ljava/lang/String;)Lokhttp3/CipherSuite;
    ...
    invoke-direct/range {v21 .. v22}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    invoke-interface/range {v21 .. v21}, Lokio/BufferedSource;->exhausted()Z
    ...
    invoke-static/range {v21 .. v21}, Lokhttp3/TlsVersion;->forJavaName(Ljava/lang/String;)Lokhttp3/TlsVersion;
    ...
    invoke-static/range {v22 .. v25}, Lokhttp3/Handshake;->get(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Ljava/util/List;)Lokhttp3/Handshake;
